            ...
            <div class="bg-white py-8 px-10 shadow-sm border border-slate-200 rounded-2xl">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input :type="show ? 'text' : 'password'" name="password" required class="w-full px-4 py-2 bg-slate-50 border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 focus:bg-white transition-all duration-200">
