    ...
    <div class="py-10 bg-gray-50/30">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
                {{-- Pembungkus agar responsive di HP --}}
                    ...
                    <table class="w-full min-w-[600px]">
                        <thead class="bg-gray-50/50 border-b border-gray-100">
                            <tr class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
                                ...
                                <th class="px-6 py-5 text-center hidden md:table-cell">Category</th>
                                <th class="px-6 py-5 text-center hidden sm:table-cell">Deletion Date</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-red-50/5 transition-all group">
                                ...
                                <td class="px-6 py-6 text-center hidden md:table-cell">
                                ...
                                <td class="px-6 py-6 text-center hidden sm:table-cell">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end items-center gap-1">
                                        <form action="{{ route('tasks.restore', $task->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" class="p-2 text-emerald-400 hover:bg-emerald-50 rounded-xl" title="Restore Task">
                ...
                {{-- Pagination / Fitur Geser Halaman --}}
